  ...
  creator: {
    click: {
      dashboard: {
        ...
        upcomingAvailabilities: '(Creator) Upcoming Availabilities Clicked',
        pastAvailabilities: '(Creator) Past Availabilities Clicked',
        manageAvailabilities: '(Creator) Manage Availabilities Clicked',
        createAvailability: '(Creator) Create Availability Clicked',
        ...
        emailListsNav: '(Creator) Email List Nav Clicked',
        ...
        referralNav: '(Creator) Referral Dashboard Nav Clicked',
      },
      sessions: {
        manage: {
