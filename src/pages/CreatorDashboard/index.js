...
import CreateCourseModule from 'pages/CreateCourseModule';
...
import MembersTags from 'pages/CreatorDashboard/AdvancedFeatures/MembersTags';
import MemberSettings from 'pages/CreatorDashboard/AdvancedFeatures/MembersSettings';
...
const CreatorDashboard = ({ match }) => {
  return (
    <Switch>
      ...
      <Route exact path={match.url + Routes.creatorDashboard.createCourseModule} component={CreateCourseModule} />
