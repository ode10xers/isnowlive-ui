      ...
      <Section>
...

        {
          ...
          <Row align="center" className={styles.zoomConnectAccount}>
            <p className={styles.textAlignCenter}>
              We will connect your Zoom Account. You will be taken to Zoom authorization page. You'll be taken back to this page.
            </p>
        ...
        }
        {
          ...
          <Row className={styles.zoomConnectAccountForm}>
            <Col span={24}>
              <p>Want a tour of this page? <a href>Watch the video</a></p>
              <p>
                Our Zoom integration will automatically create unique Zoom Meetings for each event that you create in your dashboard.
                This means that you never have to keep track of Zoom links again. Unique Zoom meetings will also be created for each recurring event.
              </p>
              <p>
                Note: Your account needs to be under a paid plan.
              </p>
            </Col>
            <Col span={24}>
              <Title level={3}>Setting up the integration</Title>
              <p>We'll need three things. Your <strong>API Key,</strong> <strong>API Secret,</strong> and <strong>email</strong> that is associated with your Zoom account.</p>
              <ol>
                <li>Go to <a href>https://marketplace.zoom.us</a> and Sign In.</li>
                ...
                <li>Collect your <strong>API Key</strong> and your <strong>API Secret,</strong> and the <strong>email</strong> of your Zoom account. Paste these below.</li>
              </ol>
              <p>
                <strong>Note:</strong>In your Zoom account (at <a href>zoom.us</a>), please go to settings and ensure that <em>Use Personal Meeting ID (PMI) when scheduling a meeting is turned <strong>off</strong></em>.
              </p>
            </Col>
            <Col span={24}>
